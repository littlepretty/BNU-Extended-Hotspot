	...
	for(n=0; n < nl; n++) {
		for(i=0; i < nr; i++) {
			for(j=0; j < nc; j++) {
				...
				} else if(model_secondary && (n==(metalidx-1))) {//last TIM layer: above is silicon, beneath is spreader
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
				...
				} else if(model_secondary && (n==spidx)) {//spreader: above is TIM, beneath is sink
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
				...
				} else if(model_secondary && (n==metalidx)) { //metal layer: above is C4, below is Si
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
				...
				} else if(model_secondary && (n==c4idx)){ // c4 layer: above is sub, below is metal
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
				...
				} else if( model_secondary && (n==subidx)) { //sub layer: above is solder, below is c4 
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
				...
				} else if(model_secondary && (n==solderidx)) { //solder layer: above is PCB, below is sub
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
				...
				} else if(model_secondary && (n==pcbidx)) { //PCB layer, above is ambient, below is solder
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
					   1.0/l[pcbidx].rz;
					wsum = NT(l,v,n,i,j,nl,nr,nc) + ST(l,v,n,i,j,nl,nr,nc) + 
				...
				}	else if(model_secondary && (n==hsidx)) {
					csum = NC(l,n,i,j,nl,nr,nc) + SC(l,n,i,j,nl,nr,nc) + 
					   EC(l,n,i,j,nl,nr,nc) + WC(l,n,i,j,nl,nr,nc) + 
					   1.0/l[spidx].rz;
					wsum = NT(l,v,n,i,j,nl,nr,nc) + ST(l,v,n,i,j,nl,nr,nc) + 
				...
				if (model->config.model_secondary && (n == c4idx)) {
					//FIXME!
				}
